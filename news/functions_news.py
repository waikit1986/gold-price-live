...
def download_news_articles() -> List[NewsArticleSchema]:
    url = (
        "https://www.alphavantage.co/query?function=NEWS_SENTIMENT"
        "&topics=economy&economy_macro,monetary,economy_fiscal"
        "&limit=300&sort=LATEST&apikey=N7XFFLQ444WX8GAT"
    )
...
def save_articles_to_db(articles: List[NewsArticleSchema]):
